"""
.. image:: prometheePUT_figures/M1.jpg
...
from core.input_validation.weights import surrogate_weights_validation

__all__ = ["surrogate_weights"]


def surrogate_weights(
    criteria_ranks: pd.Series, method: SurrogateMethod, decimal_place: int = 3
) -> pd.Series:
    """
    ...
    def _weight_order(rc: pd.Series, weights: List[Union[int, float]]) -> pd.Series:
        """
        ...
        return pd.Series(rank_summed.values, rank_summed.index, name="weights")

    def equal_weights(rc: pd.Series, dp: int = 3) -> pd.Series:
        """
    ...
    def rank_sum(rc: pd.Series, dp: int = 3) -> pd.Series:
        """
    ...
    def reciprocal_of_ranks(rc: pd.Series, dp: int = 3) -> pd.Series:
        """
    ...
    def rank_order_centroid(rc: pd.Series, dp: int = 3) -> pd.Series:
        """
