"""
    .. image:: prometheePUT_figures/M13.png
...
from core.input_validation.alternatives import alternatives_profiles_validation
from core.promethee_flow import compute_single_criterion_net_flows

__all__ = ["calculate_alternatives_profiles"]


def _calculate_net_flows(
    criteria_weights: pd.Series, criteria_net_flows: pd.DataFrame
) -> pd.Series:
    """
...
def calculate_alternatives_profiles(
