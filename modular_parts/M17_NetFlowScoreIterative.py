"""
    .. image:: prometheePUT_figures/M17.jpg
...
from core.input_validation.ranking import net_flow_score_iterative_validation

from .M10_NetFlowScore import calculate_net_flows_score

__all__ = ["calculate_netflow_score_ranking"]


def calculate_netflow_score_ranking(
    ...
    scores = calculate_net_flows_score(
        preferences, function, direction, avoid_same_scores=True
    )
    # Sort the ranking
