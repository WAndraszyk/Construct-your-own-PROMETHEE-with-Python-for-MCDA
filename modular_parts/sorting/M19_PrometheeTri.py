...
def _calculate_criteria_net_flows(
        ...
        profiles_partial_preferences: pd.DataFrame) -> Tuple[
    pd.DataFrame, pd.DataFrame]:
    """
    Calculate criteria net flows for profiles and alternatives.

    :param alternatives_partial_preferences: Tuple with 2 DataFrames with
     partial preferences
    (alternatives vs profiles and profiles vs alternatives)
    :param profiles_partial_preferences: DataFrame with partial preferences
     (profiles vs profiles)

    :return: Tuple with 2 DataFrames with criteria net flows for profiles
    and alternatives
    """
...
def _calculate_deviations(alternatives: List[str],
    ...
    :param profiles_criteria_net_flows: DataFrame with criteria net flows for
     profiles
    :param alternatives_criteria_net_flows: DataFrame with criteria net flows
     for alternatives
    :param use_marginal_value: Boolean which describe whether deviation should
     be calculated as absolute value or not
...
def _assign_alternatives_to_classes_with_minimal_deviation(
    ...
    """
    Assign every alternative to class with minimal deviation for pair
     alternative, class.
    ...
    :param assign_to_better_class: Boolean which describe preference of the
     DM in final alternative assignment when
...
def calculate_prometheetri_sorted_alternatives(
    ...
    :param criteria_weights: Series with weights of each criterion
    :param alternatives_partial_preferences: Tuple with 2 DataFrames with
     partial preferences (alternatives vs profiles
