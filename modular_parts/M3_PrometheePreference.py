"""
.. image:: prometheePUT_figures/M3.jpg
...
from core.input_validation.preference import promethee_preference_validation

__all__ = ["compute_preference_indices"]


def compute_preference_indices(
    ...
    :return: Tuple of preferences DataFrame (alternatives/profiles as index
         ...
         and criteria as index, alternatives/profiles as columns).
         With profiles, it's going to be Tuple of tuples of preferences
         DataFrames and partial preferences DataFrames.
    """
    ...
    if categories_profiles is None:
        ...
        return (
            _preferences(weights, criteria, decimal_place, partialPref, alternatives),
            partialPref,
        )
    else:
