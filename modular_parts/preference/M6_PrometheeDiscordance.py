...
def compute_discordance(criteria: List[str], partial_preferences: pd.DataFrame, tau: NumericValue,
    ...
    if not categories_profiles:
        ...
        discordance = _overall_discordance(criteria, partial_discordance, tau, decimal_place)
    else:
        partial_discordance = [
        ...
        for i in partial_discordance:
            discordance.append(_overall_discordance(criteria, i, tau, decimal_place))

    if preferences is not None:
        return overall_preference(preferences, discordance, categories_profiles, decimal_place)
    else:
