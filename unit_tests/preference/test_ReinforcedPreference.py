...
def test_reinforced_preference(alternatives, alternatives_performances, preference_thresholds, indifference_thresholds,
                               generalized_criteria, directions, reinforcement_thresholds, reinforcement_factors,
    ...
    actual, _ = compute_reinforced_preference(alternatives_performances, preference_thresholds, indifference_thresholds,
                                              generalized_criteria, directions, reinforcement_thresholds,
                                              reinforcement_factors, weights, profiles_performances)
...
if __name__ == '__main__':
    test_reinforced_preference(alternatives, alternatives_performances, preference_thresholds, indifference_thresholds,
                               generalized_criteria, directions, reinforcement_thresholds, reinforcement_factors,
                               weights, profiles_performances, profiles)
