...
from modular_parts.M22_FlowSortGDSS import calculate_flowsort_gdss_sorted_alternatives
...
def profiles_performances():
    ...
    DM1 = pd.DataFrame([[98, 8, 7], [30, 5, 3]], index=profiles, columns=criteria)

    DM2 = pd.DataFrame([[110, 8, 6], [55, 5, 4]], index=profiles, columns=criteria)

    DM3 = pd.DataFrame([[80, 7, 6], [25, 6, 2]], index=profiles, columns=criteria)
