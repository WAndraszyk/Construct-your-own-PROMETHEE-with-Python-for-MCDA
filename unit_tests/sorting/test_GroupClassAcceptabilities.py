...
def assignments():
    ...
    DM1_assignments = pd.DataFrame(
        {'worse': ['C3', 'C3', 'C3', 'C1', 'C3', 'C3', 'C3', 'C4', 'C3', 'C1',
                   'C2', 'C4'],
         'better': ['C3', 'C3', 'C3', 'C1', 'C3', 'C3', 'C3', 'C4', 'C3',
                    'C1', 'C2', 'C4']}, index=alternatives)

    DM2_assignments = pd.DataFrame(
        {'worse': ['C2', 'C2', 'C3', 'C1', 'C3', 'C3', 'C3', 'C4', 'C3', 'C1',
                   'C2', 'C4'],
         'better': ['C3', 'C3', 'C3', 'C3', 'C4', 'C3', 'C4', 'C4', 'C3',
                    'C2', 'C2', 'C4']}, index=alternatives)

    DM3_assignments = pd.DataFrame(
        {'worse': ['C2', 'C2', 'C2', 'C3', 'C2', 'C2', 'C2', 'C3', 'C3', 'C1',
                   'C1', 'C3'],
         'better': ['C2', 'C2', 'C2', 'C4', 'C2', 'C2', 'C3', 'C4', 'C3',
                    'C2', 'C2', 'C4']}, index=alternatives)

    DM4_assignments = pd.DataFrame(
        {'worse': ['C1', 'C2', 'C1', 'C3', 'C2', 'C2', 'C1', 'C2', 'C2', 'C1',
                   'C1', 'C3'],
         'better': ['C2', 'C3', 'C3', 'C4', 'C3', 'C3', 'C3', 'C4', 'C3',
                    'C3', 'C2', 'C4']}, index=alternatives)

    return [DM1_assignments, DM2_assignments, DM3_assignments,
            DM4_assignments]
